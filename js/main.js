  ...
  let createElems = () => {  
    ...
    elems.forEach(elem => {
      ...
      garbageСan2.addEventListener('dragover', event => {
        ...
        // garbageСan.style.display = 'block';'none'
        // garbageСan2.style.display = 'none';           
        console.log('нахожусь');
      });
      ...
      // garbageСan2.addEventListener('drop', () => {                     
      //   garbageСan.style.display = 'block';
      //   garbageСan2.style.display = 'none';         
      //   console.log('бросил');
      // });
      ...
      elem.addEventListener('dragend', event => {
        ...
        // elem.style.top = (event.pageY - coordY) + 'px';  
        // elem.style.left = (event.pageX - coordX) + 'px';
